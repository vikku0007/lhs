...
import { EmployeeTrainingModel } from '../../view-models/employee-training-model';
...
@Component({
  selector: 'lib-emp-proffessionaldevelopment',
  templateUrl: './emp-proffessionaldevelopment.component.html',
  styleUrls: ['./emp-proffessionaldevelopment.component.scss'],
  providers: [
    {
...
export class EmpProffessionaldevelopmentComponent implements OnInit, OnChanges {
    ...
    createEditForm(index) {
      if (index != null) {
        ...
        this.rForm = this.fb.group({
          ...
          editEndDate: ['', Validators.nullValidator],
