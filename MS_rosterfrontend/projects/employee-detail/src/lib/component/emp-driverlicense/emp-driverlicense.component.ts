...
import { EmployeeDlModel } from '../../view-models/employee-dl-model';
import { EmpDetailService } from '../../services/emp-detail.service';
import { Paging } from 'projects/viewmodels/paging';
import { MatTableDataSource } from '@angular/material/table';
import { PageEvent } from '@angular/material/paginator';
@Component({
  selector: 'lib-emp-driverlicense',
  templateUrl: './emp-driverlicense.component.html',
  styleUrls: ['./emp-driverlicense.component.scss'],
  providers: [
    {
...
export class EmpDriverlicenseComponent implements OnInit {
  ...
  selectedType: any;
  selectedorigin: any;
  constructor(private fb: FormBuilder, private empService: EmpDetailService,private commonservice:CommonService, private notificationService: NotificationService,
  ...
  createForm() {
    this.rForm = this.fb.group({
      ...
      licenseState: [null, Validators.required],
  ...
  createFormAdd() {
    this.rFormAdd = this.fb.group({
      ...
      AddlicenseState: [null, Validators.required],
