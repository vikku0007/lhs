...
@Component({
  selector: 'lib-emp-staff-warning',
  templateUrl: './emp-staff-warning.component.html',
  styleUrls: ['./emp-staff-warning.component.scss'],
  providers: [
    {
...
export class EmpStaffWarningComponent implements OnInit {
 ...
 dataSource = new MatTableDataSource(this.staffwarningList);
  ...
  selectedType: any;
  selectedName: any;
  constructor(private fb: FormBuilder,private router: Router, private route: ActivatedRoute,private loaderService: LoaderService,
    private notificationService: NotificationService, private empService: EmpDetailService,private commonservice:CommonService) { 
