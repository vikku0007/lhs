...
@Component({
  selector: 'lib-medical-shift-list',
  templateUrl: './medical-shift-list.component.html',
  styleUrls: ['./medical-shift-list.component.scss']
})

export class MedicalShiftListComponent implements OnInit {
