...
@Component({
  selector: 'lib-employee-experience',
...
export class EmployeeExperienceComponent implements OnInit, OnChanges {
    ...
    formData.append('Duration', this.rForm.get('Duration').value);
      this.empService.updateWorkExperience(formData).subscribe(res => {
        ...
        switch (this.response.status) {
          case 1:
            // const index = this.employeeWorkInfo.findIndex(x => x.id === data.Id);
            // this.employeeWorkInfo[index].company = data.Company;
            // this.employeeWorkInfo[index].jobTitle = data.JobTitle;
            // this.employeeWorkInfo[index].startDate = data.StartDate;
            // this.employeeWorkInfo[index].endDate = data.EndDate;
            // this.employeeWorkInfo[index].jobDesc = data.JobDesc;
            this.GetExperienceList();
