...
{
    public class AddCopyPasteShiftInfoCommandHandler : IRequestHandler<AddCopyPasteShiftInfoCommand, ApiResponse>
    {
        private readonly LHSDbContext _context;
        private readonly IShiftService _shiftService;
        private readonly ISessionService _ISessionService;
        public AddCopyPasteShiftInfoCommandHandler(LHSDbContext context, IShiftService shiftService, ISessionService ISessionService)
        {
            _context = context;
            _shiftService = shiftService;
            _ISessionService = ISessionService;
        }
        public async Task<ApiResponse> Handle(AddCopyPasteShiftInfoCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (_shift != null)
                {
                    ...
                    _ShiftInfo.EndDate = (_shift.StartDate.Date != _shift.EndDate.Date) ? (request.EndDate.Date.AddHours(24)) : request.EndDate.Date;
