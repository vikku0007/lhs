...
namespace LHSAPI.Application.PayRoll.Models
{
    public class IncompleteShiftInfoModel
    {
    ...
    {
        public List<IncompleteShiftInfoModel> IncompleteShiftInfoModel { get; set; }
