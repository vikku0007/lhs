...
{
    public class GetPrimaryCategoryHandler : IRequestHandler<GetPrimaryCategoryQuery, ApiResponse>
    {
        private readonly LHSDbContext _dbContext;
        //   readonly ILoggerManager _logger;
        public GetPrimaryCategoryHandler(LHSDbContext dbContext)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResponse> Handle(GetPrimaryCategoryQuery request, CancellationToken cancellationToken)
        {
