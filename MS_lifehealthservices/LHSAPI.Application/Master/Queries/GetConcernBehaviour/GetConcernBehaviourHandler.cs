...
{
    public class GetConcernBehaviourHandler : IRequestHandler<GetConcernBehaviourQuery, ApiResponse>
    {
        private readonly LHSDbContext _dbContext;
        //   readonly ILoggerManager _logger;
        public GetConcernBehaviourHandler(LHSDbContext dbContext)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResponse> Handle(GetConcernBehaviourQuery request, CancellationToken cancellationToken)
        {
