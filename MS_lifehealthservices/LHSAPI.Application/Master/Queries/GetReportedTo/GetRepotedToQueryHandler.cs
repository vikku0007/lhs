...
{
    public class GetRepotedToQueryHandler : IRequestHandler<GetRepotedToQuery, ApiResponse>
    {
        private readonly LHSDbContext _dbContext;
        //   readonly ILoggerManager _logger;
        public GetRepotedToQueryHandler(LHSDbContext dbContext)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResponse> Handle(GetRepotedToQuery request, CancellationToken cancellationToken)
        {
