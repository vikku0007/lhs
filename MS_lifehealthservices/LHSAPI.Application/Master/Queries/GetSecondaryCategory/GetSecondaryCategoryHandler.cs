...
namespace LHSAPI.Application.Master.Queries.GetSecondaryCategory
{
    public class GetSecondaryCategoryHandler : IRequestHandler<GetSecondaryCategoryQuery, ApiResponse>
    {
        private readonly LHSDbContext _dbContext;
        //   readonly ILoggerManager _logger;
        public GetSecondaryCategoryHandler(LHSDbContext dbContext)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResponse> Handle(GetSecondaryCategoryQuery request, CancellationToken cancellationToken)
        {
