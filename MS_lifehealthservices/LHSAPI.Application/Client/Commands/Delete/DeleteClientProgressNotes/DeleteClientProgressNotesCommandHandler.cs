...
namespace LHSAPI.Application.Client.Commands.Delete.DeleteClientProgressNotes
{
    ...
    public class DeleteClientProgressNotesCommandHandler : IRequestHandler<DeleteClientProgressNotesCommand, ApiResponse>
    {

        private readonly LHSDbContext _context;
        private readonly ISessionService _ISessionService;
        public DeleteClientProgressNotesCommandHandler(LHSDbContext context, ISessionService ISessionService)
        {
            _context = context;
            _ISessionService = ISessionService;
        }

        public async Task<ApiResponse> Handle(DeleteClientProgressNotesCommand request, CancellationToken cancellationToken)
        {
