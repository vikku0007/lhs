...
namespace LHSAPI.Application.Client.Commands.Delete.DeleteClientDocument
{
    ...
    public class DeleteClientDocumentHandler : IRequestHandler<DeleteClientDocumentCommand, ApiResponse>
    {

        private readonly LHSDbContext _context;

        public DeleteClientDocumentHandler(LHSDbContext context)
        {
            _context = context;

        }

        public async Task<ApiResponse> Handle(DeleteClientDocumentCommand request, CancellationToken cancellationToken)
        {
